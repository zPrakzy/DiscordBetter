...
const config = {
    ...
    patreon: "",
    donate: "https://www.paypal.com/paypalme/zprakzy",
    invite: "http://discordapp.com/users/960078734940065833",
    defaultConfig: [
        {
            type: "switch",
    ...
    changelog: [
        ...
        },
        {
          ...
          type: "added",
          items: [
              "Better animations, better uploads with better quality"
          ]
        },
        {
            ...
            type: "added",
            items: [
                "Developed by https://linktr.ee/ServerSecurity"
            ]
        }
    ]
};
